...
function cmake_build {
  ...
  cmake -DSKSURGERYOPENCVCPP_PYTHON_VERSION:STRING=${PYTHON_VERSION} -DSKSURGERYOPENCVCPP_USE_V4L:BOOL=ON -DSKSURGERYOPENCVCPP_USE_GSTREAMER:BOOL=ON -DBUILD_SUPERBUILD:BOOL=ON -DBUILD_TESTING:BOOL=ON ${extra_flags} ..
  make -j 2
