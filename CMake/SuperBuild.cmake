...
# This allows switching branches in the SKSURGERYOPENCVCPP source code and build SKSURGERYOPENCVCPP quickly, even if the
...
# SKSURGERYOPENCVCPP-configure timestamp manually before doing a superbuild. Without that the CMake cache is
...
set(EP_COMMON_ARGS
  ...
  "-DCMAKE_CXX_FLAGS:STRING=${CMAKE_CXX_FLAGS} ${SKSURGERYOPENCVCPP_CXX11_FLAG}"
  #debug flags
...
set(SKSURGERYOPENCVCPP_SUPERBUILD_DEBUG_POSTFIX d)
...
######################################################################
# Now compile SKSURGERYOPENCVCPP, using the packages we just provided.
######################################################################
if(NOT DEFINED SUPERBUILD_EXCLUDE_SKSURGERYOPENCVCPPBUILD_TARGET OR NOT SUPERBUILD_EXCLUDE_SKSURGERYOPENCVCPPBUILD_TARGET)
  ...
  set(proj SKSURGERYOPENCVCPP)
  set(proj_DEPENDENCIES ${OpenCVContrib_DEPENDS} ${OpenCV_DEPENDS} ${Eigen_DEPENDS} ${Boost_DEPENDS} ${gflags_DEPENDS} ${glog_DEPENDS} ${VTK_DEPENDS} ${FLANN_DEPENDS} ${PCL_DEPENDS} ${ArrayFire_DEPENDS})
  ...
  ExternalProject_Add(${proj}
    ...
    CMAKE_ARGS
      ...
      -DSKSURGERYOPENCVCPP_SUPERBUILD_DEBUG_POSTFIX:STRING=${SKSURGERYOPENCVCPP_SUPERBUILD_DEBUG_POSTFIX}
    CMAKE_CACHE_ARGS
      ${EP_COMMON_CACHE_ARGS}
      -DCMAKE_LIBRARY_PATH:PATH=${CMAKE_LIBRARY_PATH}
      -DCMAKE_INCLUDE_PATH:PATH=${CMAKE_INCLUDE_PATH}
      -DSKSURGERYOPENCVCPP_EXTERNAL_PROJECT_PREFIX:PATH=${ep_prefix}
      -DSKSURGERYOPENCVCPP_USE_KWSTYLE:BOOL=${SKSURGERYOPENCVCPP_USE_KWSTYLE}
      -DSKSURGERYOPENCVCPP_USE_CPPCHECK:BOOL=${SKSURGERYOPENCVCPP_USE_CPPCHECK}
      -DSKSURGERYOPENCVCPP_USE_QT:BOOL=${SKSURGERYOPENCVCPP_USE_QT}
      -DSKSURGERYOPENCVCPP_USE_OPENMP:BOOL=${SKSURGERYOPENCVCPP_USE_OPENMP}
      -DSKSURGERYOPENCVCPP_USE_CUDA:BOOL=${SKSURGERYOPENCVCPP_USE_CUDA}
      -DSKSURGERYOPENCVCPP_DELAYLOAD_CUDA:BOOL=${SKSURGERYOPENCVCPP_DELAYLOAD_CUDA}
      -DSKSURGERYOPENCVCPP_CUDA_ARCH_BIN:STRING=${SKSURGERYOPENCVCPP_CUDA_ARCH_BIN}
      -DCUDA_TOOLKIT_ROOT_DIR:PATH=${CUDA_TOOLKIT_ROOT_DIR}
      -DSKSURGERYOPENCVCPP_USE_MPI:BOOL=${SKSURGERYOPENCVCPP_USE_MPI}
      -DCMAKE_INSTALL_PREFIX:PATH=${CMAKE_INSTALL_PREFIX}
      "-DCMAKE_INSTALL_RPATH:STRING=${_install_rpath}"
      -DCMAKE_VERBOSE_MAKEFILE:BOOL=${CMAKE_VERBOSE_MAKEFILE}
      -DBUILD_TESTING:BOOL=${BUILD_TESTING} # The value set in EP_COMMON_ARGS normally forces this off, but we may need SKSURGERYOPENCVCPP to be on.
      ...
      -DSKSURGERYOPENCVCPP_PYTHON_VERSION:STRING=${SKSURGERYOPENCVCPP_PYTHON_VERSION}
      -DBUILD_UNITY_WRAPPER:BOOL=${BUILD_UNITY_WRAPPER}
      -DSKSURGERYOPENCVCPP_UNITY_PLUGIN_DIR:PATH=${SKSURGERYOPENCVCPP_UNITY_PLUGIN_DIR}
