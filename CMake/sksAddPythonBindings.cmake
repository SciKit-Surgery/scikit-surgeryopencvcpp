...
if(BUILD_Python_Boost OR BUILD_Python_PyBind)
  ...
  set(Python_ADDITIONAL_VERSIONS ${SKSURGERYOPENCVCPP_PYTHON_VERSION})
  ...
  if(BUILD_Python_Boost)
    ...
    if (WITHIN_SUBBUILD)
      list(APPEND SKSURGERYOPENCVCPP_BOOST_LIBS "python${PYTHON_VERSION_MAJOR}${PYTHON_VERSION_MINOR}")
	  ...
	  # list(APPEND SKSURGERYOPENCVCPP_BOOST_LIBS "numpy${PYTHON_VERSION_MAJOR}${PYTHON_VERSION_MINOR}")
    else()
      list(APPEND SKSURGERYOPENCVCPP_BOOST_LIBS "python")
    endif()
    list(REMOVE_DUPLICATES SKSURGERYOPENCVCPP_BOOST_LIBS)
  endif()
endif()
