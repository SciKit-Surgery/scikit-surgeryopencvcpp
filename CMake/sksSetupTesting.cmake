...
mitkFunctionGetVersion(${CMAKE_SOURCE_DIR} SKSURGERYOPENCVCPP)
niftkMacroGetGitDateTime(${CMAKE_SOURCE_DIR} SKSURGERYOPENCVCPP)
niftkMacroGetGitBranch(${CMAKE_SOURCE_DIR} SKSURGERYOPENCVCPP)
...
if(CMAKE_GENERATOR MATCHES Make AND NOT (CMAKE_GENERATOR MATCHES NMake) )
  ...
  set(CTBN "${osname}-${cpu}-${CompilerName}-${CMAKE_CXX_COMPILER_VERSION}-${SKSURGERYOPENCVCPP_BRANCH_NAME}-${SKSURGERYOPENCVCPP_REVISION_SHORTID}")

else()

  set(CTBN "${CMAKE_GENERATOR}-${SKSURGERYOPENCVCPP_BRANCH_NAME}-${SKSURGERYOPENCVCPP_REVISION_SHORTID}")
...
if(BUILD_TESTING)
  set(BUILDNAME "SKSURGERYOPENCVCPP" CACHE STRING "Name of build on the dashboard")
  mark_as_advanced(BUILDNAME)
