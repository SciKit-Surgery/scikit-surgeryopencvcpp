...
set(SKSURGERYOPENCVCPP_USE_Boost 1)
set(SKSURGERYOPENCVCPP_USE_Boost_LIBRARIES ${SKSURGERYOPENCVCPP_BOOST_LIBS})
set(SKSURGERYOPENCVCPP_BUILD_PYTHON_BINDINGS OFF)
...
string(REPLACE "^^" ";" SKSURGERYOPENCVCPP_USE_Boost_LIBRARIES "${SKSURGERYOPENCVCPP_USE_Boost_LIBRARIES}")

if(NOT DEFINED BOOST_ROOT AND NOT SKSURGERYOPENCVCPP_USE_SYSTEM_Boost)
  ...
  if(SKSURGERYOPENCVCPP_USE_Boost_LIBRARIES)
    string(REPLACE ";" "," _boost_libs "${SKSURGERYOPENCVCPP_USE_Boost_LIBRARIES}")
    foreach(_boost_lib ${SKSURGERYOPENCVCPP_USE_Boost_LIBRARIES})
	  ...
	  if("${_boost_lib}" STREQUAL "python" OR "${_boost_lib}" STREQUAL "python${PYTHON_VERSION_MAJOR}${PYTHON_VERSION_MINOR}")
	    set(SKSURGERYOPENCVCPP_BUILD_PYTHON_BINDINGS ON)
	  endif()
    endforeach()
  endif()
  ...
  if(SKSURGERYOPENCVCPP_BUILD_PYTHON_BINDINGS)
  ...
  set(_boost_cxxflags )
  if(CMAKE_CXX_FLAGS OR SKSURGERYOPENCVCPP_CXX11_FLAG OR PythonLibs_FOUND)
    set(_boost_cxxflags "cxxflags=${SKSURGERYOPENCVCPP_CXX11_FLAG} ${CMAKE_CXX_FLAGS}")
    if(WIN32)
  ...
  # Manual install commands (for a SKSURGERYOPENCVCPP super-build install)
