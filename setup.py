...
#   SKSURGERYOPENCVCPP_PYTHON_MODULE_NAME to give the output python module the correct name.
#   SKSURGERYOPENCVCPP_PYTHON_OUTPUT_DIRECTORY to produce the output python module in the correct place
...
class CMakeExtension(Extension):
    def __init__(self, name, sourcedir=''):
        ...
        self.build_dir = os.path.join(self.super_build_dir, 'SKSURGERYOPENCVCPP-build')
...
class CMakeBuild(build_ext):
    ...
    def build_extension(self, ext):
        ...
        cmake_args = ['-DSKSURGERYOPENCVCPP_PYTHON_OUTPUT_DIRECTORY:PATH=' + ext_dir,
                      '-DSKSURGERYOPENCVCPP_PYTHON_MODULE_NAME:STRING=' + ext.name
                      ]
        build_args = []
